...
6. Run `pip install -r requirements.txt --use-feature=2020-resolver` to install the required dependencies.
...
13. Now `OBS-Camera` camera should be available in Zoom (or other videoconferencing software).
